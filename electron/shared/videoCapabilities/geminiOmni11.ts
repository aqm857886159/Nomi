...
export const GEMINI_OMNI_11_ARCHETYPE: ModelArchetype = {
  id: "gemini-omni-1.1", family: "gemini-omni", label: "Gemini Omni 1.1 Flash", kind: "video", defaultModeId: "t2v", transportTaskKind: "text_to_video",
  identifierPatterns: ["google/gemini-omni-flash-1-1", "gemini-omni-flash-1-1"],
  ...
  modes: [
    ...
    { id: "firstlast", intent: "firstlast", vendorTerm: "首尾帧", hint: "首帧必填，尾帧可选", promptRequired: true, transportTaskKind: "image_to_video", slots: [{ kind: "first_frame", label: "首帧", min: 1, max: 1, inputKey: "first_frame_url" }, { kind: "last_frame", label: "尾帧", min: 0, max: 1, inputKey: "last_frame_url" }], params: PARAMS },
    { id: "reference", intent: "character", vendorTerm: "参考图", hint: "最多 7 张角色、场景或风格参考图", promptRequired: true, transportTaskKind: "image_to_video", slots: [{ kind: "image_ref", label: "参考图", min: 1, max: 7, inputKey: "image_urls" }], params: PARAMS },
  ],
};
