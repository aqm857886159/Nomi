...
//
// 这是 MiniMax **官方原生** V2 线缆（vendorKey "minimax"、id "hailuo-h3"）；与 kie 聚合线
// `minimax-h3`（minimaxH3.ts）和 apimart 聚合线 `minimax-h3-apimart`（minimaxH3Apimart.ts）
// 是三条不同线缆，模型 key / 报文契约互不共用（P4）。
