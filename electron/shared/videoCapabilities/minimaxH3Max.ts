...
export const MINIMAX_H3_MAX_ARCHETYPE: ModelArchetype = {
  ...
  sources: [{ url: "https://platform.minimaxi.com/docs/api-reference/video-generation-v2", checkedAt: "2026-08-30", vendorKey: "minimax", covers: "POST /v2/video_generation: MiniMax-H3-Max supports text and first/last-frame video, 480P/768P, 5–15 seconds." }],
  modes: [
