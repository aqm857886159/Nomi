...
const CANVAS_PLAN_TAG_NAME = "tapcanvas_canvas_plan";
...
const canvasPlanNodeSchema = z.object({
...
const canvasPlanEdgeSchema = z.object({
...
const CANVAS_PLAN_PROTOCOL_FORMAT_HINT =
...
const CANVAS_PLAN_VISUAL_PROMPT_REQUIRED_HINT =
...
const CANVAS_PLAN_STORYBOARD_EDITOR_REQUIRED_HINT =
...
const CANVAS_PLAN_VIDEO_PROMPT_REQUIRED_HINT =
...
const CANVAS_PLAN_VIDEO_GOVERNANCE_HINT =
	'- 若需要导演视角、经典镜头借鉴、动作边界、物理约束等信息，必须直接写进 `prompt` 本体；不要拆到不会参与模型调用的旁路字段。';

const CANVAS_PLAN_NOVEL_TRACEABILITY_REQUIRED_HINT =
...
module.exports = {
	...
	canvasPlanNodeSchema,
	canvasPlanEdgeSchema,
	canvasPlanSchema,
