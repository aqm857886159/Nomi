...
const ALLOWLIST = {
  ...
  "src/workbench/generationCanvas/nodes/BaseGenerationNode.tsx": 695, // …→ 731（2026-08-25 P4 S6：多镜叠加合一 ProductionShotOverlays）→ 713（2026-08-29 React Flow 单内核：移除旧布局与缩放分支）→ 710（2026-09-07 agent-artifact：正文/浮条插槽移出壳 + composer 排除表收进 resolveRenderKind）→ 695（2026-09-14 媒体预览：尺寸 reconciler 收成一处、注释精简）
