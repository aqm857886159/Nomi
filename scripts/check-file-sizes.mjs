...
const ALLOWLIST = {
  ...
  "src/workbench/generationCanvas/nodes/BaseGenerationNode.tsx": 561, // …→ 713（2026-08-29 React Flow 单内核：移除旧布局与缩放分支）→ 710（2026-09-07 agent-artifact：正文/浮条插槽移出壳 + composer 排除表收进 resolveRenderKind）→ 677（2026-09-12 S3：四个整表选择器收进 canvasNodeGenerationIndex）→ 654（2026-09-21 合并 ① 按门岗提示拧紧） → 561（2026-09-24 草稿镜：错误卡改读执行面孔，按门岗提示拧紧）
