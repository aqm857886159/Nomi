...
Date: 2026-08-27
Baseline: Nomi v0.21.0 (`origin/main` at `0f363e69`)
Status: approved in conversation; implement on the current baseline
...
- No new top floating copy button.
- No custom progress bar inside video thumbnails.
- No forced sidebar collapse on project changes.
- No new logo or Windows icon asset.
