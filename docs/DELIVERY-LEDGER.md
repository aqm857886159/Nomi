...
| 📋 方案待拍板 | [2026-08-29-video-recreation-product-loop.md](plan/2026-08-29-video-recreation-product-loop.md) | 视频复刻：画布内最小产品闭环与 Agent 落地方案 |
...
- 合计扫描：451 篇方案文档（docs/plan/ 与 docs/superpowers/plans/，不含 INDEX.md）
