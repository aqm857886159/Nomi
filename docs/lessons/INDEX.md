...
- [迁移等价要对用户行为，不是对上一版代码](migration-parity-needs-user-behavior.md) — 磁吸把手的旧 selected 门槛被迁移测试保护；按未选中外侧 hover/拖线任务验收；[实施方案](../plan/2026-09-08-canvas-magnetic-handle.md)。
