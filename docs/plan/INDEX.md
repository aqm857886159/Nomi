...
| [2026-08-27-auto-edit-architecture.md](2026-08-27-auto-edit-architecture.md) | **E2 配套：内部 Agent 接线 + 外部对标**（主文档是 PR #179 的 `2026-08-26-p5-e2-structured-rough-cut.md`，本文只补它未覆盖的 Agent capability 接线与竞品/开源对标）；含分镜两路 schema 分叉断点 | 📋 |
