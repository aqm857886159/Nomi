...
| [2026-09-05-skill-agent-workbench-execution-plan.md](2026-09-05-skill-agent-workbench-execution-plan.md) | **Skill 聚合区 + 全屏 Agent 工作台独立执行方案**：外部来源/版权 catalog、统一 Agent Host、脚本→分镜→生成→视频拆解小 PR 边界与真实用户 H/B/E/T/N 验收 | 📋 |
