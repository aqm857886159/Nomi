...
| [2026-09-01-catalog-read-only-observability.md](2026-09-01-catalog-read-only-observability.md) | 目录高版本只读态从「只能 catch 写异常」升为 catalog health 结构化状态：产品出 i18n 可执行文案、走查起飞点 fail-fast（治 2026-08-31 逐点 catch 没关住的假绿类） | ✅ |
