...
- Fresh V8 run on the merged `origin/main=0c17317328dcfd29d72fb3c8235353981d92058d` tree: 6 files, `61 passed / 74 skipped`; repository-level selected-file summary remains `48.94% statements (762/1557)`, `42.16% branches (600/1423)`. This is explicitly not the scoped gate and is not claimed as 100%.
