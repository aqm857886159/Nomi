 ...
 */
export const LAB_ROLES = ['visual', 'walk-agent-panel-v4', 'walk-editing', 'walk-storyboard', 'walk-host-config', 'walk-vendor-order', 'walk-canvas-add-menu', 'walk-settings', 'walk-canvas-frame', 'walk-depth-action', 'walk-catalog-liveness', 'walk-primitives-actions', 'walk-primitives-forms', 'walk-primitives-menu', 'walk-primitives-surfaces', 'walk-settings-sound', 'walk-shot-table', 'walk-node-composer-bar']
