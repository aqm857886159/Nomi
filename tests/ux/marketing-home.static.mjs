...
const expectMobileSafeConversion = (document, heading, boundary, language) => {
  ...
  expectBefore(
    conversion,
    'docs/media/nomi-canvas-group-wechat-2026-10-01.jpg',
...
const files = [
  ...
  'marketing/assets/group-wechat-2026-10-01.jpg',
...
for (const html of [zh, en]) {
  ...
  expect(html.includes('/assets/group-wechat-2026-10-01.jpg'), 'new group QR is used')
  expect(
...
expect(
  fs
    .readFileSync(path.join(root, 'marketing/assets/group-wechat-2026-10-01.jpg'))
    .equals(fs.readFileSync(path.join(root, 'docs/media/nomi-canvas-group-wechat-2026-10-01.jpg'))),
...
expect(
  readmeZh.includes('docs/media/nomi-canvas-group-wechat-2026-10-01.jpg'),
...
expect(
  readmeEn.includes('docs/media/nomi-canvas-group-wechat-2026-10-01.jpg'),
...
for (const [token, label] of [
  ['<img src="docs/media/nomi-canvas-group-wechat-2026-10-01.jpg"', 'group QR'],
