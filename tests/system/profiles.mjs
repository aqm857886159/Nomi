const stage = (id, command, args = [], options = {}) => ({ id, command, args, required: options.required !== false });
...
export const STAGES = {
  ...
  "real-generation": stage("real-generation", "node", ["tests/ux/real-generation-export.e2e.mjs"]),
};
