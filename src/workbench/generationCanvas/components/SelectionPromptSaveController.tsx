        ...
        >
          ...
          >
            <header className="flex h-14 shrink-0 items-center justify-between border-b border-nomi-line-soft px-5">
              ...
              <button
                type="button"
                className="grid size-8 place-items-center rounded-nomi-sm border-0 bg-transparent text-nomi-ink-45 hover:bg-nomi-ink-05 hover:text-nomi-ink"
                onClick={closeDraft}
              >
            ...
            <div className="grid min-h-0 gap-4 overflow-y-auto p-5">
              {draft.referenceImages.length > 0 ? (
                <div className="relative overflow-hidden rounded-nomi-sm bg-nomi-bg">
                  <img
                    src={draft.referenceImages[0].url}
                    alt=""
                    className="block aspect-video max-h-56 w-full object-cover"
                  />
                  <button
                    type="button"
              ...
              <label className="grid gap-1.5">
                <span className="text-caption font-medium text-nomi-ink-60">
                  {t('generationCommon.savePrompt.type')}
                </span>
                <select
              ...
              <label className="grid gap-1.5">
                <span className="text-caption font-medium text-nomi-ink-60">
                  {t('generationCommon.savePrompt.selectedText')}
                </span>
                <textarea
              ...
              <div className="flex items-center justify-end gap-3 pt-1">
                <button
                  type="button"
                  className="h-10 rounded-nomi-sm border border-nomi-line bg-transparent px-4 text-body-sm text-nomi-ink-60 hover:bg-nomi-ink-05"
                  onClick={closeDraft}
                >
                ...
                <button
                  type="button"
                  className="h-10 rounded-nomi-sm border-0 bg-nomi-ink px-5 text-body-sm font-semibold text-nomi-paper hover:bg-nomi-accent"
                  onClick={saveDraft}
                >
