/**
 * 任务面板的分组——**唯一**一份，顺序即面板从上到下的顺序（样张
 * docs/design/mockups/2026-09-25-agent-panel-tidy/ D1-A 拍板：要你动手的排最上面，打开面板第一眼就是它）。
 *
 ...
 */
export const TASK_CENTER_GROUPS = ['attention', 'running', 'queued', 'done'] as const
