...
import { ResidentApprovalCard, ResidentStreamingText, ResidentThinkingState, ResidentToolChips, type ResidentToolChipData } from './resident/ResidentUiPrimitives'
...
export default function ProjectAgentResidentShell({ surface }: { surface: ResidentSurface }): JSX.Element {
  ...
  // onKeyDown 合并两条分支各自独有的按键行为：'@' 开引用菜单（main）+ Enter 提交（HEAD）——
  // 两者互不相干，都要留，别选边。
