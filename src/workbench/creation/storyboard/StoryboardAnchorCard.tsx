  ...
  return (
    <div className="px-2.5 py-2" data-anchor-card={anchor.id}>
      <div className="flex items-center gap-2.5">
        <button
          type="button"
          aria-label={t('storyboardEditor.anchor.typeAria', { type: t(`storyboardEditor.anchor.kind.${anchor.kind}` as 'storyboardEditor.anchor.kind.character') })}
          title={t('storyboardEditor.anchor.switchType')}
        ...
        >
          {desc || t('storyboardEditor.anchor.addDescription')}
        </button>
