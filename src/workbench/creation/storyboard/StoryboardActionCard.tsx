...
import { IconArrowRight, IconMovie, IconUserPlus, IconX } from '@tabler/icons-react'
import { cn } from '../../../utils/cn'
import { WorkbenchButton } from '../../../design'
import { DEFAULT_STORYBOARD_SHOT_MODE, type StoryboardShotMode } from './storyboardActionCardModel'
 ...
 *
 * 拆镜头只保留一个白话行动。媒体类型在方案编辑器里逐镜头选择，
 * 不把内部的图片/视频实现术语提前甩给用户。
 */
...
export type { StoryboardShotMode } from './storyboardActionCardModel'
  ...
  return (
    <div className={cn('flex flex-col gap-2 p-3 rounded-nomi border border-nomi-line bg-nomi-paper')} data-action-card={kind}>
      ...
      <WorkbenchButton
        ...
        disabled={resolved}
        onClick={() => onRun(DEFAULT_STORYBOARD_SHOT_MODE)}
