export const zhCreationAi = {
  ...
  storyboardResultObsolete: '目标分镜已被删除，这次迟到的修改没有应用。',
  unknownError: '未知错误',
...
export const enCreationAi = {
  ...
  storyboardResultObsolete: 'The target storyboard was deleted, so this late revision was not applied.',
