export const zhSettings = {
  ...
  ai: {
    ...
    policy: {
      ...
      openModelCatalog: '去模型目录',
      hardBudget: '单次制作授权上限（CNY）',
      hardBudgetHint: 'Nomi 只会为本次合同内的任务预留额度；留空会阻止付费制作。供应商最终账单仍以其计费记录为准。',
      providers: '允许的供应商',
...
export const enSettings = {
  ...
  ai: {
    ...
    policy: {
      ...
      hardBudget: 'Per-production authorization limit (CNY)',
      hardBudgetHint: 'Nomi reserves only for jobs in the approved contract. Leaving this empty blocks paid production; the provider billing record remains authoritative.',
