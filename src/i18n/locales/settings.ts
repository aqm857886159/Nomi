export const zhSettings = {
  ...
  file: {
    ...
    projectLocationConfigured: '路径已设置 · Nomi 不上传文件',
    projectLocationCheck: '检查目录',
    projectLocationChecking: '检查中…',
    projectLocationCheckSuccess: '项目目录可用。同步由外部同步工具负责。',
    projectLocationSyncHint: '请在 VerySync、坚果云或其他同步工具中把此目录设为双向同步。',
...
export const enSettings = {
  ...
  file: {
    ...
    projectLocationConfigured: 'Path set · Nomi does not upload files',
    projectLocationCheck: 'Check folder',
    projectLocationChecking: 'Checking…',
    projectLocationCheckSuccess: 'The project folder is available. An external sync client handles transfer.',
    projectLocationSyncHint: 'Mark this folder for two-way sync in VerySync, Nutstore, or another sync client.',
