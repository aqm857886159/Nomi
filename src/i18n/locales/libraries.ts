export const zhLibraries = {
  ...
  skill: {
    ...
    auto: '自动',
    featuredAssets: '素材规划',
    featuredAssetsDescription: '角色、场景、道具一次拆清，并生成可用提示词',
...
export const enLibraries = {
  ...
  skill: {
    ...
    auto: 'Auto',
    featuredAssets: 'Asset planning',
    featuredAssetsDescription: 'Break out characters, scenes, and props with ready-to-use prompts',
