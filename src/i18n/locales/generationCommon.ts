export const zhGenerationCommon = {
  ...
  imageToolbar: {
    ...
    makeup: '建参考图',
    makeupHint: '以这张图为基础，新建角色或场景参考节点（不自动生成）',
    decomposing: '拆解中',
    aiEdit: 'AI 编辑',
    ...
    removeBackgroundFailed: '抠图资源加载失败',
    retryRemoveBackground: '重试',
    editGroup: '改这张',
    more: '更多',
    splitAndTransform: '拆分与变换',
    handoff: '交接',
    openInWhiteboard: '在画板中打开',
    split: '切图',
    fourView: '四视图（2×2）',
    gridNine: '九宫格（3×3）',
    transform: '变换',
...
export const enGenerationCommon = {
  ...
  imageToolbar: {
    ...
    removeBackgroundFailed: 'Background-removal resources failed to load',
    retryRemoveBackground: 'Retry',
    editGroup: 'Edit image',
    more: 'More',
    splitAndTransform: 'Split and transform',
    handoff: 'Continue in',
    openInWhiteboard: 'Open in whiteboard',
    split: 'Split',
  ...
  videoToolbar: {
    ...
    captureGroup: 'Capture from this video',
