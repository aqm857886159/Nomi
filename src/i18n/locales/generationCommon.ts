export const zhGenerationCommon = {
  ...
  node: {
    ...
    videoDeconstruction: {
      ...
      cuts: '镜头切点',
      structure: '内容结构',
      cutsHint: '只找画面切点；不需要内容分析引擎。',
      close: '关闭视频拆解',
      closeHint: '关闭面板；后台分析任务会继续',
      checkingEngine: '正在检查本地拆解引擎',
      engineUnavailable: '内容分析暂不可用',
      engineUnavailableHint: '镜头切点仍可使用。到设置检查 e-cut 地址、令牌和运行状态。',
      structureEmpty: '还没有内容结构',
      structureEmptyHint: '本地引擎会读取镜头、文字和时间关系。通常需要几分钟，可以关闭面板继续创作。',
      openSettings: '检查设置',
      start: '开始分析',
      starting: '正在提交…',
      resultIntegrityError: '结果或证据校验失败，Nomi 没有展示这份不可信结果。',
      externalMode: '已允许外部推理',
      localEvidenceMode: '本地证据模式',
      localSubmitDisclosure: '本次只在本机 e-cut 中处理镜头、OCR 和语音证据，不调用外部模型。',
      externalSubmitDisclosure: '本次会把分析所需的关键帧和识别文字发送到 e-cut 配置的模型 API；完整项目仍留在本地。',
      changeMode: '更改本次使用的模式',
      engineStage: 'e-cut 原始阶段',
      waitingEngineUpdate: '等待引擎第一次更新',
      engineOfflinePolling: '本地引擎暂时离线',
      engineOfflinePollingHint: 'Nomi 只会查询已经提交的任务，不会重新上传视频。恢复 e-cut 后会自动继续。',
      lastEngineCheck: '最近检查：{{time}}',
      safeToClose: '关闭后任务继续，可从任务中心返回',
      runInBackground: '后台运行',
      needsAttention: '这次分析需要处理',
      needsAttentionHint: '任务没有产出可验证的结构结果。',
      retry: '使用当前设置重新分析',
      loadingResult: '正在校验本地结果与证据…',
      sceneCount: '{{count}} 个营销段落',
      evidenceSectionCount: '{{count}} 个证据段落',
      evidenceFirstHint: '原始证据在前，结构解读在后；识别文字建议发布前人工校对。',
      localEvidenceResultHint: '本地模式只整理镜头、识别文字和时间证据，不判断营销角色；需要结构复用时，可在设置允许外部模型后重新分析。',
      evidenceRole: '证据',
      selectScene: '选择段落：{{title}}',
      sourceFrameAt: '源视频 {{time}} 位置预览',
      rawEvidence: '原始证据 · 已校验引用',
      unverifiedEvidence: '证据不可验证',
      unverifiedEvidenceHint: '独立 OCR/ASR 证据缺失或引用不匹配，Nomi 不会把 storyboard 文字当作原文展示。',
      copyEvidence: '复制证据文字',
      expandEvidence: '展开全文',
      collapseEvidence: '收起全文',
      asrLabel: '语音识别',
      ocrLabel: '屏幕文字',
      noSpeech: '未检测到可识别语音',
      noOcr: '未检测到屏幕文字',
      ...
      overallInterpretation: '整体结构解读',
      overallEvidenceSummary: '整体证据摘要',
      selectedShots: '已选 {{count}} 个镜头',
      reuseStructure: '沿用结构写新方案',
      configureInference: '配置结构分析',
      addToCanvas: '放到画布',
      sourceVideo: '源视频',
      provenanceBadge: '来自 {{source}} · {{time}} · 证据',
      provenanceTitle: '返回 {{source}} 的第 {{shot}} 镜（{{time}}）',
      status: { analyzing: '分析中', complete: '已拆解', attention: '需处理' },
    },
    assetDrop: {
      full: '最多 {{max}} 个{{label}}',
  ...
  card: {
    ...
    generating: '生成中',
    comfyCancel: '取消',
    comfyCancelAria: '取消这次 ComfyUI 生成',
  ...
  videoToolbar: {
    ...
    shotCuts: '拆解视频',
    shotCutsHint: '查看镜头切点或内容结构，再选择需要的结果放到画布',
  },
  agentPlan: {
    reference: '参考',
    keyframe: '关键帧',
  ...
  production: {
    ...
    description: {
      ...
      storyboardReady: '先审阅并确认分镜，Nomi 才会把它落到画布并生成制作合同。',
      contractDeclined: '本次决定已记录；没有提交生成任务，也没有产生支出。调整分镜或制作范围后可创建新的合同。',
    },
...
export const enGenerationCommon = {
  ...
  node: {
    ...
    videoDeconstruction: {
      title: 'Deconstruct video',
      mode: 'Deconstruction mode',
      cuts: 'Shot cuts',
      structure: 'Content structure',
      cutsHint: 'Finds visual cuts only; the content-analysis engine is not required.',
      close: 'Close video deconstruction',
      closeHint: 'Close the panel; background analysis will continue',
      checkingEngine: 'Checking the local deconstruction engine',
      engineUnavailable: 'Content analysis is unavailable',
      engineUnavailableHint: 'Shot cuts still work. Check the e-cut address, token, and runtime in Settings.',
      structureEmpty: 'No content structure yet',
      structureEmptyHint: 'The local engine reads shots, text, and timing relationships. It usually takes a few minutes, and you can close this panel while it runs.',
      openSettings: 'Check settings',
      start: 'Start analysis',
      starting: 'Submitting…',
      resultIntegrityError: 'Result or evidence verification failed, so Nomi did not show the untrusted result.',
      externalMode: 'External inference allowed',
      localEvidenceMode: 'Local evidence mode',
      localSubmitDisclosure: 'This run processes shot, OCR, and speech evidence only in local e-cut and does not call an external model.',
      externalSubmitDisclosure: 'This run may send required keyframes and recognized text to the model API configured in e-cut. The full project remains local.',
      changeMode: 'Change the mode for this run',
      engineStage: 'Raw e-cut stage',
      waitingEngineUpdate: 'Waiting for the first engine update',
      engineOfflinePolling: 'Local engine temporarily offline',
      engineOfflinePollingHint: 'Nomi will only check the existing task and will not upload the video again. It resumes automatically when e-cut returns.',
      lastEngineCheck: 'Last checked: {{time}}',
      safeToClose: 'The task continues after closing; return from Tasks',
      runInBackground: 'Run in background',
      needsAttention: 'This analysis needs attention',
      needsAttentionHint: 'The task did not produce a verifiable structure result.',
      retry: 'Analyze again with current settings',
      loadingResult: 'Verifying the local result and evidence…',
      sceneCount: '{{count}} marketing sections',
      evidenceSectionCount: '{{count}} evidence sections',
      evidenceFirstHint: 'Raw evidence comes first, followed by interpretation. Review recognized text before publishing.',
      localEvidenceResultHint: 'Local mode organizes shots, recognized text, and timing evidence without inferring marketing roles. To reuse a marketing structure, allow an external model in Settings and analyze again.',
      evidenceRole: 'Evidence',
      selectScene: 'Select section: {{title}}',
      sourceFrameAt: 'Source-video preview around {{time}}',
      rawEvidence: 'Raw evidence · reference verified',
      unverifiedEvidence: 'Evidence cannot be verified',
      unverifiedEvidenceHint: 'Independent OCR/ASR evidence is missing or its reference does not match. Nomi will not present storyboard text as a transcript.',
      copyEvidence: 'Copy evidence text',
      expandEvidence: 'Show all',
      collapseEvidence: 'Collapse',
      asrLabel: 'Speech transcript',
      ocrLabel: 'On-screen text',
      noSpeech: 'No recognizable speech detected',
      noOcr: 'No on-screen text detected',
      interpretation: 'Structure interpretation',
      evidenceSummary: 'Evidence summary',
      overallInterpretation: 'Overall structure interpretation',
      overallEvidenceSummary: 'Overall evidence summary',
      selectedShots: '{{count}} shots selected',
      reuseStructure: 'Use structure for a new plan',
      configureInference: 'Configure structure analysis',
      addToCanvas: 'Add to canvas',
      sourceVideo: 'source video',
      provenanceBadge: 'From {{source}} · {{time}} · evidence',
      provenanceTitle: 'Return to shot {{shot}} in {{source}} ({{time}})',
      status: { analyzing: 'Analyzing', complete: 'Deconstructed', attention: 'Needs attention' },
    },
    assetDrop: {
  ...
  card: {
    ...
    generating: 'Generating',
    comfyCancel: 'Cancel',
    comfyCancelAria: 'Cancel this ComfyUI generation',
  ...
  videoToolbar: {
    ...
    shotCuts: 'Deconstruct video',
    shotCutsHint: 'Inspect shot cuts or content structure, then add only the results you choose to the canvas',
  },
  agentPlan: {
  ...
  production: {
    ...
    status: {
      ...
      contractDeclined: 'The production contract was declined',
    },
    description: {
      ...
      storyboardReady: 'Review and confirm the storyboard before Nomi lays it out and creates the production contract.',
      contractDeclined: 'This decision is recorded. No generation task was submitted and no spend occurred. Revise the storyboard or scope to create a new contract.',
    },
    ...
    gate: {
      ...
      contractTitle: 'Approve production contract and budget',
