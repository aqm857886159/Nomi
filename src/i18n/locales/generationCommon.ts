export const zhGenerationCommon = {
  ...
  batchPlan: {
    ...
    unfrozenAnchors: '{{count}} 个镜头的角色/场景卡还没冻结——先在卡上点「冻结」',
  ...
  production: {
    ...
    description: {
      ...
      checkpointGate: '主角和场景形象定了才开拍。形象没问题就一镜镜拍下去；哪张不满意，只重画形象，镜头不动。',
    ...
    gate: {
      ...
      checkpointTitle: '先看看主角形象，满意再开拍',
      checkpointSummary: 'Nomi 先把主角和场景的定妆形象生成好了。形象定下来，接着就一镜镜开拍；哪张形象不满意，只重画形象——已排好的镜头不动。',
      checkpointApprove: '形象没问题，开拍',
      checkpointReject: '不满意，只重画形象',
      checkpointAnchorLabel: '主角形象',
...
export const enGenerationCommon = {
  ...
  batchPlan: {
    ...
    unfrozenAnchors: '{{count}} shots reference character/scene cards that are not frozen yet — freeze them on the card first',
  ...
  production: {
    ...
    status: {
      ...
      checkpointGate: 'The character look is ready — take a look before shooting',
    ...
    description: {
      ...
      checkpointGate: 'Shooting starts once the character and scene looks are set. If a look is off, redo only the look — the shots stay untouched.',
    ...
    gate: {
      ...
      checkpointTitle: 'Check the character look before shooting',
      checkpointSummary: 'Nomi generated the lead character and scene looks first. Approve the look and it shoots each shot in turn; if a look is off, regenerate only the look — the shots stay untouched.',
      checkpointApprove: 'Look is good, start shooting',
      checkpointReject: 'Not happy — redo the look only',
      checkpointAnchorLabel: 'Character look',
