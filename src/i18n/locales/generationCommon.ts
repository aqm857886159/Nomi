export const zhGenerationCommon = {
  sourceTask: {
    invalid: '输入不符合要求',
    missing: "请连接一段符合要求的已生成视频，或填写它的源任务 ID；本次尚未提交生成。",
    multiple: "此操作只接受一段源视频，请只保留一条源视频连线。",
    unknown: "这段视频缺少可核验的生成记录，请选择保留原始生成记录的视频。",
    provider: "源视频与当前模型不属于同一供应商，请选择生成原视频时使用的供应商。",
    model: "此操作要求源视频由 {{model}} 生成，请选择对应的原始成片。",
    parameter: "源视频已是 {{actual}}；此操作只接受 {{expected}}。请直接使用已有成片，或连接符合要求的源视频。",
    conflict: "填写的源任务 ID 与连线视频不一致，请清空旧 ID 或重新选择源视频。",
  },
  ...
  production: {
    ...
    gate: {
      ...
      openProductionPolicy: '接入模型',
      missingPolicyTitle: '还有 {{count}} 项没接入',
      missingPolicyFallbackTitle: '本次需要的供应商或模型还没接入',
      missingPolicyMessage: '在「模型」里接上它们后才能批准；当前不会提交生成任务，也不会产生支出。',
      missingPolicyProviders: '供应商：{{providers}} 未接入',
      missingPolicyModels: '模型：{{models}} 未接入或不可用',
...
export const enGenerationCommon = {
  sourceTask: {
    invalid: 'Input does not meet the requirements',
    missing: "Connect a compatible generated video or enter its source task ID. No generation was submitted.",
    multiple: "This operation accepts one source video. Keep only one source connection.",
    unknown: "This video has no verifiable generation record. Select a video with its original provenance.",
    provider: "The source video belongs to a different provider. Select the provider that generated it.",
    model: "This operation requires a source video generated by {{model}}.",
    parameter: "The source video's {{key}} is {{actual}}; this operation only accepts {{expected}}. Use the existing output or connect a compatible source.",
    conflict: "The entered task ID does not match the connected video. Clear the old ID or select the intended source.",
  },
  defaultTitles: {
  ...
  parameters: {
    ...
    audioOnly: 'Choose an audio file',
  ...
  production: {
    ...
    gate: {
      ...
      openProductionPolicy: 'Connect models',
      missingPolicyTitle: '{{count}} not connected',
      missingPolicyFallbackTitle: 'A provider or model this run needs is not connected',
      missingPolicyMessage: 'Connect them under Models before approving. No generation is submitted and no spend is authorized yet.',
      missingPolicyProviders: 'Providers not connected: {{providers}}',
      missingPolicyModels: 'Models not connected or unavailable: {{models}}',
    ...
    contract: {
      ...
      notSet: 'Not set',
      policyAllowed: 'Connected',
      policyMissing: 'Not connected',
