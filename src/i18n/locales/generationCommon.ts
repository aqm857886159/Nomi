export const zhGenerationCommon = {
  ...
  production: {
    ...
    description: {
      providerUnavailable: '供应商 {{provider}} 在 Nomi 本地预检时失败。任务没有提交，本次没有产生支出。',
      providerUnavailableNoReplacement: '供应商 {{provider}} 在提交前不可用。任务没有提交，也没有产生支出；请为当前镜头选择其他可用模型。',
    ...
    gate: {
      ...
      missingPolicyBudget: '本次制作授权上限：未设置',
      ...
      contractSummary: '确认镜头、模型和本次制作授权上限后，Nomi 才会提交任何付费生成。',
      replacementContractTitle: '核对新的制作合同',
      replacementContractSummary: '旧供应商和旧批准已经作废。确认新的供应商、镜头范围与预算后才会恢复生成。',
    ...
    recovery: {
      ...
      recommended: '推荐',
      affected: '涉及任务',
      affectedValue: '{{count}} 个镜头',
      next: '下一步',
      nextValue: '核对新合同，生成仍保持暂停',
      confirmTitle: '换供应商并作废旧合同？',
      confirmMessage: '{{failedProvider}} 没有收到任务，也没有产生支出。Nomi 将把 {{count}} 个镜头改绑到 {{replacementProvider}}，作废旧合同并立即打开新合同；不会自动批准或扣费。',
      confirm: '改用 {{provider}}',
      failed: '供应商没有更换',
    },
    roughCut: {
...
export const enGenerationCommon = {
  ...
  production: {
    ...
    description: {
      providerUnavailable: '{{provider}} failed Nomi\'s local preflight. No task was submitted and no spend occurred.',
      providerUnavailableNoReplacement: '{{provider}} is unavailable before submission. No task was submitted and no spend occurred; choose another executable model for the affected shots.',
    ...
    gate: {
      ...
      missingPolicyBudget: 'Production authorization limit: not set',
      ...
      contractSummary: 'Review shots, models, and the production authorization limit before Nomi submits any paid generation.',
      replacementContractTitle: 'Review the replacement production contract',
      replacementContractSummary: 'The old provider binding and approval are revoked. Generation resumes only after you approve the new provider, scope, and budget.',
    ...
    recovery: {
      ...
      affectedValue: '{{count}} shots',
      next: 'Next',
      nextValue: 'Review a new contract; generation remains paused',
      confirmTitle: 'Switch provider and revoke the old contract?',
      confirmMessage: '{{failedProvider}} received no task and no spend occurred. Nomi will rebind {{count}} shots to {{replacementProvider}}, revoke the old contract, and open a new one. It will not approve or charge automatically.',
      confirm: 'Use {{provider}}',
      failed: 'Provider was not changed',
    },
    roughCut: {
