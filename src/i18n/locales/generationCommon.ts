export const zhGenerationCommon = {
  ...
  production: {
    ...
    gate: {
      ...
      missingBudgetMessage: '请先到「设置 → AI 与模型 → 默认模型策略」填写制作硬预算上限（CNY）。没有明确上限，Nomi 不会提交任何付费生成。',
...
export const enGenerationCommon = {
  ...
  production: {
    ...
    gate: {
      ...
      missingBudgetMessage: 'Open Settings → AI & models → Default model policy and enter a hard production budget (CNY). Nomi will not submit paid generation without an explicit ceiling.',
