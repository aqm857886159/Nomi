...
export const zhCN = {
  ...
  studio: {
    ...
    hostConfigRepaired: '已修复 Claude Code 的 Nomi 接入配置，重启 Claude Code 生效',
...
export const en = {
  ...
  studio: {
    ...
    hostConfigRepaired: 'Claude Code’s Nomi connection was repaired. Restart Claude Code to apply it.',
