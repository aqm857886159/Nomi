/**
 * 点完「开始自检」之后该关弹层还是该留下报错——这一格的唯一判据。
 *
 ...
 */
export type IntegrationSelfCheckOutcome = { done: true } | { done: false; reasonCode: string | null }

export function integrationSelfCheckOutcome(projection: unknown): IntegrationSelfCheckOutcome {
