...
export const PROVIDER_PRESETS: ProviderPreset[] = [
  ...
  { id: 'stepfun', label: '阶跃星辰', providerKind: 'openai-compatible', baseUrl: 'https://api.stepfun.com/v1', keyUrl: 'https://platform.stepfun.com/account/keys', group: 'official' },
  { id: 'stepfun-plan', label: '阶跃星辰 Step Plan', providerKind: 'openai-compatible', baseUrl: 'https://api.stepfun.com/step_plan/v1', keyUrl: 'https://platform.stepfun.com/account/keys', group: 'official' },
]
