...
import { Portal, Title, Text, Group } from '@mantine/core'
import { DesignButton, PanelCard } from '../../design'
        ...
        >
          <PanelCard className="feature-tour-card glass" style={{ pointerEvents: 'auto' }}>
            <Group className="feature-tour-card-header" justify="space-between" align="flex-start" gap="sm" mb={6}>
              ...
              <DesignButton className="feature-tour-skip" size="xs" variant="subtle" onClick={onClose}>
                跳过
              </DesignButton>
            </Group>
            ...
            <Group className="feature-tour-footer" justify="space-between" mt="md">
              <DesignButton className="feature-tour-prev" size="xs" variant="default" disabled={isFirst} onClick={() => setActiveIndex((i) => Math.max(0, i - 1))}>
                上一个
              </DesignButton>
              <DesignButton
